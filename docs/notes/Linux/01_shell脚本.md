...
[记得我读大学的时候，会写sh脚本是非常厉害的事情，大家都认为sh脚本语法复杂，用vim去写代码简直是折磨，完了也不好调试，于是当时我学习的时候也有一种很强烈的畏难情绪，结果到现在，我的sh脚本基本上都是AI写的了，我就负责review一下，只写
编程的程序员肯定是被淘汰了，但同时也会感觉的到凄凉，自己花了那么长时间掌握的技能这么快就贬值，还挺不舒服的。 写于2026.4.13日]
